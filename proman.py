...
# These are just for testing save_to_db and update_db(works!)
board_json_save = {"board": {"title": "avocado", "color": "tile-red"}}
card_json_save = {"card": {"title": "avocado1", "color": "tile-pink", "board": 5}}
board_json_update = {"board": {"title": "avocadooo", "color": "tile-red", "id": 5}}
card_json_update = {"card": {"title": "avocadooo1", "color": "tile-pink", "board": 5, "id": 5}}
